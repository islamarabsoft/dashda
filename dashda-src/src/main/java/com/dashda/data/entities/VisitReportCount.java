...
public VisitReportCount(Integer productlineid, String productline, String regional, Integer regionalid, String flm, Integer flmid,
		String mp, Integer mpid, BigInteger count) {
	super();
