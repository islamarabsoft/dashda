...
public class DoctorDTO implements AbstractDTO{
	...
	/**
	 * @return the nearestPharmacy
	 */
	public String getNearestPharmacy() {
		return nearestPharmacy;
	}
	/**
	 * @param nearestPharmacy the nearestPharmacy to set
	 */
	public void setNearestPharmacy(String nearestPharmacy) {
		this.nearestPharmacy = nearestPharmacy;
	}
	/**
	 * @return the workingMorningPlace
	 */
	public String getWorkingMorningPlace() {
		return workingMorningPlace;
	}
	/**
	 * @param workingMorningPlace the workingMorningPlace to set
	 */
